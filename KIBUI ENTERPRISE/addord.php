...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;">ADD order </h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>honest is so important</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
					<div class="input-group">
						...
						<input type="text" class="form-control" placeholder="customer id" name="customer_id" required="required">
					</div><br>
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
						<input type="text" class="form-control" placeholder="FULL Name" name="cust_name" required="required">
					</div><br>
					<div class="input-group">
					...
					<div class="input-group">
						...
						<input class="form-control" placeholder="grade" name="grade" required="required">
					</div><br>
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
						<input  class="form-control" placeholder="salesman id" name="salesman_id" required="required">
					</div><br>
					
					
					

					<center><button id="signup" class="btn btn-info btn-lg" name="sign_up">add</button></center>
					<?php include("insert_custmor.php"); ?>
				</form>
			</div>
		</div>
	</div>
